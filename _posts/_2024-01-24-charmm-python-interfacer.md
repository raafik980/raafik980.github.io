...
Inerface to Q-Chem can be considered as one of the decently documented interfaces as well as provide several key options to control specifications of the QM/MM simulations. The interface is implemented in the file **gukini.F90**. The interface is called from the CHARMM script using the following command:
